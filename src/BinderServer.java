...
public class BinderServer {
    ...
    /*
    * @TODO: Implement Close Program after finish Binding (all requests must push thru) (BinderServer)
    * @TODO: Sanity Check - Print leftovers (Hydrogen/Oxygen)
    * @TODO: Sanity Check - Check if molecule is requested first after binding (Hydrogen/Oxygen)
    * @TODO: Check Errors from TODO 3
    * */
